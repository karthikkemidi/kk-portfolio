              ...
              <CardContent className="p-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {['OOP', 'Python', 'Data Structures', 'DBMS', 'Computer Architecture', 'Web Technologies', 'AI', 'ML'].map((course) => (
                    <span
                      key={course}
                      className="px-3 py-2 bg-blue-600/20 border border-blue-400/30 rounded-full text-sm text-blue-300"
                    >
                      {course}
                    </span>
                  ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {skills.map((skillGroup, index) => (
              <Card key={index} className="bg-navy-800/50 border-blue-400/30 hover:scale-105 transition-all duration-300 group">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.tech.map((tech) => (
                      <span
                        key={tech}
                        className="px-2 py-1 bg-cyan-600/20 border border-cyan-400/30 rounded text-xs text-cyan-300"
                      >
                        {tech}
                      </span>
                    ))}
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              {experience.map((exp, index) => (
                ...
                >
                  <Card className={`bg-navy-800/50 border-blue-400/30 w-full md:w-96 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {achievements.map((achievement, index) => (
              <Card key={index} className="bg-navy-800/50 border-cyan-400/30 hover:scale-105 transition-all duration-300 group">
                ...
                <div className="space-y-6">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:kemidikarthik2004@gmail.com"
